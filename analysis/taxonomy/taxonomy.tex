...
\paragraph{Results}
\begin{my_itemize}
 \item Graph Mining vs. Na\"{\i}ve Bayes: performance comparison between the m-InfoSift approach and the Probabilistic Bayesian approach clearly show a significant improvement as compared to Bayesian. Accuracy improvement is 10% at the lowest and 70% at the highest. 
\end{my_itemize}
