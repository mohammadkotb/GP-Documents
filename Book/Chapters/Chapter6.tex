...
\item Using both the sender feature and the bag of words (word frequency) achieves best results in most of the cases. Adding more features not necessarily imporves the accuracy.
