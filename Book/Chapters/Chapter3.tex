...
\section{Conclusion}
In this chapter the main features used for email classification was introduced. At the end of the chapter, the tuple of the classifier features was presented. In next chapter, project conceptualization and the proposed workflow will be discussed.
