...
classification are presented. Detailed classifier features are included in section \ref{sec:3_detailed_classifier_features} . The tuple of classifier features used as an input for the email  classifier is presented in  section \ref{sec:3_classifier_tuple}. The Chapter is concluded in section \ref{sec:conclusion_3}.
%==============================================================================
\newpage
\section {Classifier Features}
\label{sec:3_classifier_features}
The following table illustrates the features used for email classification. These features are extracted from the papers surveyed in section \ref{sec:related_work}.
...
Close study of table 3.1 suggests using the detailed classification features listed in the table blow.
\label{sec:3_detailed_classifier_features}
...
Close study of the detailed classification features listed in section \ref{sec:3_detailed_classifier_features} suggests using the following classification tuple as an input for the email classifier.
\label{sec:3_classifier_tuple}
