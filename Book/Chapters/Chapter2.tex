...
\subsection{Taxonomy according to the different learning algorithms used in different papers}
...
\begin{center}
  \begin{table}[H]
    \begin{tabular}{|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
      ...
      & \\ \hline
    \end{tabular}
    \caption{Taxonomy according to the different learning algorithms used in different papers.}
  \end{table}
\end{center}

\subsection{Taxonomy according to the different learning capabilities}
The following table classifies some recent research papers in the field of email 
